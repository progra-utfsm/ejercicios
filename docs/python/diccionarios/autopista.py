def mayor_movilidad(transitos):
    ...
    for patente, portico in transitos: # Recorrido de la estructura
    ...
    for patente in conteo: # Recorremos el diccionario
        tupla = (conteo[patente], patente) # Dejamos el conteo primero para ordenar con sort
        lista.append(tupla) # Agregamos la tupla
